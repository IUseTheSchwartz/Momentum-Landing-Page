...
function CreatorBar({ settings }) {
  ...
  const items = [
    ...
    scUrl && {
      ...
      label: "Snapchat",
      href: scUrl,
      // Clean centered ghost outline (balanced at 16×16)
      Icon: (props) => (
        <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" {...props}>
          <path d="M4 19c1.8-.4 2.8-1.1 3.2-2 .1-.3-.1-.6-.4-.7-1.1-.3-2.2-.5-3.2-1.1-.6-.3-.9-.7-.9-1.2 0-.5.3-.9.8-1.1.7-.3 1.1-.4 1.5-.8A5.9 5.9 0 0 1 5 10 7 7 0 1 1 19 10c0 .3-.1.7-.2 1 .4.4.8.5 1.5.8.5.2.8.6.8 1.1 0 .5-.3.9-.9 1.2-1 .6-2.1.8-3.2 1.1-.3.1-.5.4-.4.7.4.9 1.4 1.6 3.2 2 .4.1.7.4.7.8 0 .5-.5.9-1.2.9-1.8 0-3.2-.6-4.2-1.5A6.5 6.5 0 0 1 12 18a6.5 6.5 0 0 1-3.1.6c-1 1-2.4 1.5-4.2 1.5-.7 0-1.2-.4-1.2-.9 0-.4.3-.7.7-.8Z"/>
          <path d="M9 11a1 1 0 1 0 0 2m6-2a1 1 0 1 0 0 2" />
        </svg>
      )
    },
  ].filter(Boolean);
